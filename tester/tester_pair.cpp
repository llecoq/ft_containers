...
int	tester_pair_std(void)
{
	std::pair <std::string,double> product1;                     // default constructor
	std::pair <std::string,double> product2 ("tomatoes",2.30);   // value init
	std::pair <std::string,double> product3 (product2);          // copy constructor
	std::pair <std::string,double> product3_copy;
	...
	std::pair <TestClass,int> foooo;
	std::pair <TestClass,int> baaar;
	
	foooo = std::make_pair (10,20);
	baaar = std::make_pair (10.5,'A'); // ok: implicit conversion from pair<double,char>
